...
- How/when should I use i3-workspace-reset?
  - You can use the i3-workspace-reset file however you want. Consider using i3-workspace-reset with dmenu.
